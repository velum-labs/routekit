/**
 * Adapted from RouteKit Eval's eval discovery implementation.
 *
...
import { type EvalDiscovery, EvalDiscoveryError, type EvalTargetOptions } from "../model.js";

export const EVAL_SUFFIX = ".eval.ts";

const IGNORED_SEGMENTS = new Set(["node_modules", ".routekit/eval", ".git"]);
