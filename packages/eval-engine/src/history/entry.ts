...
const decodeEntry = Schema.decodeUnknownOption(Schema.fromJsonString(EvalHistoryEntrySchema));
...
const encodeEntry = Schema.encodeOption(Schema.fromJsonString(EvalHistoryEntrySchema));
 ...
 */
const readEvalHistory = Effect.fn("EvalHistory.read")(function* (historyPath: string) {
