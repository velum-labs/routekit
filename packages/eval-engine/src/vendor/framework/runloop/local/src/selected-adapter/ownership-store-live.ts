...
const OWNERSHIP_DIR_SEGMENTS = [".ori", "sessions"] as const;
const JSON_INDENT = 2;
...
/**
 * Ownership on disk under `<workspace>/.ori/sessions/`, deliberately outside
 * `.ori/logs/`: log sidecars are a pruned projection of runtime events, and a
