...
/**
 * Rollover compaction (ORI-471): when a session's context is nearly full — or
...
const ROLLOVER_MODE_ENV = "ORI_COMPACTION_ROLLOVER";
const ROLLOVER_THRESHOLD_ENV = "ORI_COMPACTION_ROLLOVER_THRESHOLD";

// 0.85 leaves headroom for the summary turn itself to fit; community
// convergence is that 95%-style triggers fire too late (ORI-471 research).
