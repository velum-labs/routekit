...
// Injected into the `ori code` system prompt so the agent reports its actual
// runtime instead of guessing its identity (ORI-397): routed models routinely
