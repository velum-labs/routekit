...
const ROOT_PERSONA_FEATURE_ID = "@ori/root";
...
/**
 * Read the workspace-root `ori.md` and contribute (1) its markdown body as an
 ...
 * shadows the built-in default. Returns empty record sets when `ori.md` is absent
