...
type RetryEvent = Extract<
  ...
  { readonly method: "ori/retry" }
>;
type CompactionEvent = Extract<
  CodexKnownSessionEvent,
  { readonly method: "ori/compaction" }
>;
