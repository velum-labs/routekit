...
const FreshModuleBuildPolicyRef = Context.Reference<FreshModuleBuildPolicy>(
  "ori/kernel/FreshModuleBuildPolicy",
  {
...
// scoped package specifier (e.g. `effect`, `@ori-runloop/local/layers`) can
...
const nodeImportsFieldSubpathPlugin: FreshModuleBuildPlugin = {
  name: "ori-resolve-node-imports-field-subpaths",
  setup(build) {
...
export const resolveBarePackageImportsPlugin: FreshModuleBuildPlugin = {
  name: "ori-resolve-bare-package-imports",
  setup(build) {
