...
export interface RootPersonaFrontmatter {
  ...
  /** Default model slug for the workspace (e.g. `openrouter/auto`). */
  ...
  /**
   * The Ori CLI version that scaffolded this workspace, stamped by `ori init`
   ...
   * gate behavior. Tooling (e.g. an `ori upgrade` diagnostic) can compare it
