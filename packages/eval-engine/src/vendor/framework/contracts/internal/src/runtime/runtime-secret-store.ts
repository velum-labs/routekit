 ...
 * `@ori-engine/runtime-io` adapter (`runtime-environment.ts`) as
...
>()("ori/runtime/RuntimeSecretStore") {
  /**
   ...
   * resolvable secret; the `@ori-engine/runtime-io` `runtimeSecretStoreFromRecord`
