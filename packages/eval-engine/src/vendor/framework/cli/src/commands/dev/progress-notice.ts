...
// makes `ori eval --json | jq` work, so a notice printed there turns a valid
// document into a parse error for whoever is reading it. `ori eval` boots this
 ...
 * one (`ori start` among them), and requiring the service here would push a layer
