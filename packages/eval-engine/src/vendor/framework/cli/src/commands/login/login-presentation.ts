...
> => {
  if (noBrowser) {
    return cliIo.writeStdout(
      `Open this URL to sign in to OpenRouter:\n\n  ${authUrl}\n\nWaiting for you to finish in the browser...\n`
    );
  }
  return cliIo
    .writeStdout(
      `Opening your browser to sign in to OpenRouter...\nIf nothing opens, visit:\n\n  ${authUrl}\n\nWaiting for you to finish in the browser...\n`
    )
...
export const formatSuccess = (
  ...
  return `\nSigned in to OpenRouter${who}. API key saved to ${savedPath}.\nIf \`ori dev\` is already running, restart it to pick up the new key.\n`;
};
