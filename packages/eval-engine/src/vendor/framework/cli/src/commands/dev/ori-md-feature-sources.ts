...
const ROOT_PERSONA_FILE = "ori.md";

/**
 * Read the workspace-root `ori.md`'s `features:` array — the additional feature
 ...
 *
 * Best-effort: a missing `ori.md`, an unreadable file, or invalid frontmatter
 ...
 * in declared order.
 */
export const readOriMdFeatureSources = Effect.fn(
  "DevCommand.oriMdFeatureSources"
