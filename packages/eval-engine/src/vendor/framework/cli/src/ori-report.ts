...
// cut belongs to a launched tool, not Ori's own output mode.
...
export const reportOriCliBootstrapFailure = Effect.fn(
  "OriCli.reportBootstrapFailure"
...
// at the outer `runMain` edge, outside the command's `oriCliLayer` scope.
