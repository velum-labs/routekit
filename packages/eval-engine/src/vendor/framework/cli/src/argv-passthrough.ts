...
/**
 * The extra arguments meant for a launched tool, like `ori claude` or
 * `ori codex`. Commands like these need to forward whatever the user typed
...
/**
 * Scans past recognised leading global flags (`ori --json codex ...`) and
 ...
 * (allowing recognised global flags before it, e.g. `ori --json codex`) is
 * returned untouched.
 *
