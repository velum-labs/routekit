...
import { GatewayModelsLive } from "./vendor/framework/runloop/local/src/gateway/models-live.ts";
import {
  nodeServicesLayer,
  cliIoLayer,
  hostRuntimeLayer,
...
const codePersonaMarkdown = readTextAsset(import.meta.url, "../../../assets/skills/code-persona.md");
...
const gatewayModelsLayer = GatewayModelsLive.pipe(Layer.provide(fetchHttpClientLayer));
