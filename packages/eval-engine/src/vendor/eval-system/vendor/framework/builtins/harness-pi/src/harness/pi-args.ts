import type { HarnessInvokeOptions } from "../../../routekit-eval/src/index.ts";
...
const buildPiArgs = (
  ...
  const extensionArgs = [
    ...
    injected.gatewaySessionAttributionExtensionPath,
  ...
  // when non-blank, otherwise the configured default, always gateway/-forced.
  args.push(
    MODEL_FLAG,
    resolvePiModel(
      options.model,
