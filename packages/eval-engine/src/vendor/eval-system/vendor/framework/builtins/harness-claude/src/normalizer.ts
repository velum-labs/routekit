import type { AgentRuntimeEvent, RuntimeNormalizeState } from "../../routekit-eval/src/index.ts";
...
// Claude only emits tool_result (the diagnostic event tapped by `routekit-eval logs`, RFC
