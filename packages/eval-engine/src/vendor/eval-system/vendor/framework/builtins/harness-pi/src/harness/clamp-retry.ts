// pi owns the Gateway request, so routekit-eval cannot lower max_tokens in place. When
// Gateway rejects a turn with a 402 ("requires more credits, or fewer
...
import type { AgentRuntimeEvent } from "../../../routekit-eval/src/index.ts";

import { Stream } from "effect";
import { isTerminalRuntimeEvent } from "../../../routekit-eval/src/index.ts";
...
// The affordable-tokens figure from a clampable Gateway 402 carried by an
