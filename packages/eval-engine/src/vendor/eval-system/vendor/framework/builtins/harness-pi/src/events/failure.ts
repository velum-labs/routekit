import type { AgentFailure, AgentFailureCode } from "../../../routekit-eval/src/index.ts";
 ...
 * summary request that overflowed would come back as `ROUTEKIT_EVAL_CONTEXT_OVERFLOW`
...
export const piCompactionFailure = (
  ...
  return agentFailure({
    code: "ROUTEKIT_EVAL_PI_COMPACTION_FAILED",
    kind: "internal",
 ...
 * condition ROUTEKIT_EVAL recognizes. Callers that already know which operation failed
