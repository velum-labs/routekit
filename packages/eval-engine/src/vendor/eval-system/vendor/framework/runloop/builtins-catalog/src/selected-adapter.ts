...
/**
 * The built-in selected-adapter (ACP coordinator-core, ROUTEKIT_EVAL-548) inventory.
 * Pi (ROUTEKIT_EVAL-429) and Claude (ROUTEKIT_EVAL-430) are production cutovers. This array is
