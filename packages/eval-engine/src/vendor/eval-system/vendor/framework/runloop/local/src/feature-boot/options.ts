...
export interface FeatureBootOptions {
   ...
   * default selection walks this list (after layering any `routekit-eval.md` preference and
   ...
   * contributions, composed by `order` like any other prompt. `routekit-eval code` uses
   ...
   * locate the root-persona `routekit-eval.md` (RFC 0002 root-persona.md). Optional: when omitted, boot
