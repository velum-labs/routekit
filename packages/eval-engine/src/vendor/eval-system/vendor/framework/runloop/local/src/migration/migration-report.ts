 ...
 *   2. the workspace's recorded generating CLI version (`routekit-eval.md` `version`)
...
interface MigrationReport {
  /** The generating CLI version recorded in `routekit-eval.md`, or undefined if absent. */
...
// A contribution import failure carries the stable code `ROUTEKIT_EVAL_BOOT_IMPORT_<KIND>`
...
// the human message.
const IMPORT_DIAGNOSTIC_PREFIX = "ROUTEKIT_EVAL_BOOT_IMPORT_";
...
// form (formerly ROUTEKIT_EVAL-167) reports this code rather than a capability-scoped
// `ROUTEKIT_EVAL_BOOT_IMPORT_<KIND>` one, since the failure is not about any single
// contribution's value shape.
const FEATURE_MODULE_IMPORT_CODE = "ROUTEKIT_EVAL_BOOT_IMPORT_FEATURE_MODULE";
 ...
 *   - `generatedWithVersion` — the `routekit-eval.md` `version` stamp (or undefined);
