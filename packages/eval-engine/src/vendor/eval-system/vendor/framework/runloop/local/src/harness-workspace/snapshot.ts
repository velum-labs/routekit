...
const SNAPSHOT_ROOT = ".routekit-eval/snapshot";
 ...
 * an immutable copy of every skill directory under `.routekit-eval/snapshot/gen-<n>/`, exposed
 * through the single `.routekit-eval/snapshot/current` symlink. The swap is one atomic rename,
