...
import type { GatewayModels } from "../../gateway/models-service.ts";
...
export type RuntimeCommand = Parameters<RouteKitEvalDaemonShape["invoke"]>[0];
...
>["event"];
export interface RouteKitEvalDaemonServices {
  ...
  /** Rollover compaction policy (ROUTEKIT_EVAL-471), env-resolved at daemon boot. */
