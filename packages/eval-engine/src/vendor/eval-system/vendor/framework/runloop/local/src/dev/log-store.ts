...
/**
 * Best-effort retention for `.routekit-eval/logs`: walk runs newest-first and delete any
...
/**
 * Daemon-side reader over the on-disk `.routekit-eval/logs` directory: the port the HTTP
...
export class DevLogStore extends Context.Service<
  DevLogStore,
  DevLogStoreShape
>()("routekit-eval/runtime/DevLogStore") {
  /**
   ...
   * implementation that reads real `.routekit-eval/logs` files lives in the
