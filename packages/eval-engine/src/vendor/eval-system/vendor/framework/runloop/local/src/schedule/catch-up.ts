// The durable last-fire record is the newest `routeKitEval_schedule_runs` row — no
 ...
 * `routeKitEval_schedule_runs` row, so no separate last-fire store is needed: a single
