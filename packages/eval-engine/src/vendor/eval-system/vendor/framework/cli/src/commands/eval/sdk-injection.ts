...
const SDK_PACKAGE_NAME = "routekit-eval";
...
/**
 * NODE_PATH points at the temp root so `<temp>/node_modules/routekit-eval` is visible to
 * CJS resolution. ESM ignores NODE_PATH, so {@link materializeEvalSdk} also
 * symlinks `cwd/node_modules/routekit-eval` at the same package.
 */
