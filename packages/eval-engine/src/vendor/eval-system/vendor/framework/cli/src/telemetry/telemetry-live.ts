 ...
 * buffered in memory and flushed in the background to the Gateway ingest
...
const TELEMETRY_ENDPOINT = "http://127.0.0.1:8080/v1/routekit-eval/telemetry";
const TELEMETRY_ENV = "ROUTEKIT_EVAL_TELEMETRY";
/**
...
RouteKitEval collects anonymous usage telemetry to improve the CLI.
It records which CLI commands you run (like \`routekit-eval code\` or \`routekit-eval tui\`),
...
/**
 * The live {@link Telemetry} adapter. Resolves the `ROUTEKIT_EVAL_TELEMETRY` opt-out and
