...
import type { ResolvedAutoUpdateConfig } from "./routekit-eval-config.ts";
 ...
 * auto-apply threshold) are surfaced to the log with an `routekit-eval update` instruction.
 */
