...
/**
 * The root persona `routekit-eval.md` (RFC 0002 root-persona.md) lives at the workspace root, ABOVE
 * `featuresRoot`, so neither the feature-root watch nor its polling snapshot
 * observe it. This stream watches it on its own and emits `[routekit-eval.md]` whenever
