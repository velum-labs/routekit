...
const formatIndex = (): string =>
  [
    ...
    "",
    "Run `routekit-eval eval docs <topic>` for a section, or `routekit-eval eval docs all` for everything.",
    "",
  ].join("\n");
    ...
    Effect.gen(function* () {
      ...
      if (selectedTopic === undefined) {
        ...
        return yield* new CliFailureError({
          ...
          hint: `Valid topics: ${validTopics}. Run \`routekit-eval eval docs\` to see the index.`,
        });
      }
