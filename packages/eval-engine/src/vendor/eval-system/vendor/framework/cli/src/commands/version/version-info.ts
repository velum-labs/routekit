 ...
 * so a locally linked `routekit-eval --version` still tracks the workspace manifest.
 */
...
/** Human-readable single-line rendering: `routekit-eval 0.0.0`. */
...
export const formatVersionUpdateText = (
  ...
  const updateCommand =
    status.channel === "alpha" ? "routekit-eval update --alpha" : "routekit-eval update";
...
/** Machine-readable rendering: `{"name":"@routekit-eval-runtime/cli","version":"0.0.0"}`. */
