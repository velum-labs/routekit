...
// import directly —
//
//   import { log } from "routekit-eval/logger";
...
// log (`routekit-eval logs`) / CLI stderr — so authors never reach for `console.*`.
//
 ...
 */
const FEATURE_LOG_GLOBAL_KEY = Symbol.for("routekit-eval/feature-log/v1");
 ...
 * layer + an in-process daemon under `routekit-eval dev`) each release cleanly without
