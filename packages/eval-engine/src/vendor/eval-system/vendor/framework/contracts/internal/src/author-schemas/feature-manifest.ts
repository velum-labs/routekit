 ...
 * with the plain TypeScript `FeatureModule` shape from `@routekit-eval-contracts/author`;
 ...
 * drift. Built-in feature ids (`@routekit-eval-builtins/*`) are minted in code, never
