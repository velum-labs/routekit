...
// static slug the agent harness loads (from `routekit-eval.md`/`SKILL.md` frontmatter, the
// built-in default, or the `--model` flag), not a feature-provided contribution.
// See RFC 0002 Root `routekit-eval.md` Persona for the resolver and precedence.
