...
// (formerly ROUTEKIT_EVAL-167) is no longer a recognized authoring shape: every
 ...
 * unrecognized key — so a real ROUTEKIT_EVAL-167-era `feature.ts` still fails loudly
...
const DEFERRED_FEATURE_MODULE_EXPORTS = [
  ...
  },
  {
    ...
    file: FEATURE_MODULE_FILE,
    reason:
      "legacy generation defaults are deferred; set the default model via the root routekit-eval.md frontmatter",
  },
