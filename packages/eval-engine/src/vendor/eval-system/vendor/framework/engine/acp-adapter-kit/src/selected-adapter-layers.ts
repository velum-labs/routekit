 ...
 * `AcpClientRequestHandler` by `@routekit-eval-engine/acp-agent` and `AcpTransport` by
 * `@routekit-eval-engine/acp-client` — and imported as-is; these factories only bind an
