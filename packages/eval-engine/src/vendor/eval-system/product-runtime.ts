...
import type { RouteKitEvalDaemonLayerOptions } from "./vendor/framework/runloop/local/src/daemon/core/index.ts";
...
import { makeRouteKitEvalDaemonLayer } from "./vendor/framework/runloop/local/src/daemon/core/index.ts";
...
export interface EvalDaemonDependenciesOptions {
  readonly authSource?: RouteKitEvalDaemonLayerOptions["authSource"];
...
type EvalDaemonService = Layer.Success<ReturnType<typeof makeRouteKitEvalDaemonLayer>>;
