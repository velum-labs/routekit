...
[TypeScript reference](https://github.com/velum-labs/routekit/blob/main/docs/typescript-reference.md). Generated API docs are produced on demand for the docs site (`pnpm docs:dev`).
