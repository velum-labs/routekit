...
path changes, and incompatible host-protocol upgrades. The first upgrade from a
legacy combined daemon performs one graceful hard restart before later upgrades
can roll.
