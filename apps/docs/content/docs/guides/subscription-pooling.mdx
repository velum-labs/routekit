...
The first successful login enables its provider in the canonical configuration.
...
Read [monitor and operate RouteKit](/docs/guides/operations) for activity markers,
...
## What subscription pooling does not change
