...
import {
  materializeLunaRepositoryRetrievalEpisodes,
  writeLunaRepositoryRetrievalMaterialization,
  type LunaRepositoryRetrievalMode,
...
console.log(JSON.stringify({
  ...
  operational: {
    ...
    meanWallClockMillisecondsPerEpisode:
      wallClockMilliseconds / materialization.episodes.length,
  },
}, null, 2));
