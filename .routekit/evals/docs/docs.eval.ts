...
const cases = [
  {
    ...
    prompt:
      'Explain how a user should apply the "Why RouteKit" section to complete the documented workflow. Include concrete actions and important constraints.',
    context:
    ...
    rubric:
      'The response must accurately apply the "Why RouteKit" section, include its actionable details, and introduce no unsupported claims.'
  },
  {
    id: "readme-quickstart",
    prompt:
      'Explain how a user should apply the "Quickstart" section to complete the documented workflow. Include concrete actions and important constraints.',
    context:
    ...
    rubric:
      'The response must accurately apply the "Quickstart" section, include its actionable details, and introduce no unsupported claims.'
  },
  {
    id: "readme-what-you-can-connect",
    prompt:
      'Explain how a user should apply the "What you can connect" section to complete the documented workflow. Include concrete actions and important constraints.',
    context:
    ...
    rubric:
      'The response must accurately apply the "What you can connect" section, include its actionable details, and introduce no unsupported claims.'
  }
] as const;
